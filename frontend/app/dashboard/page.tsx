...
export default function Dashboard() {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 p-6 pt-24 max-w-7xl mx-auto min-h-screen">
      {/* Sidebar */}
      ...
      <div className="w-full lg:w-3/4">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-4xl font-bold bg-gradient-to-r from-white via-blue-100 to-gray-400 bg-clip-text text-transparent drop-shadow-sm">
            Problem Dashboard
          </h1>
