            ...
            <div className="min-h-screen bg-[#0a0f1c] p-4 md:p-8 pt-24">
                <div className="max-w-6xl mx-auto space-y-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
                        ...
                        <div className="lg:col-span-1 space-y-6 bg-[#111827] rounded-2xl border border-gray-800 p-6 shadow-lg h-fit max-h-[85vh] overflow-y-auto custom-scrollbar sticky top-24">
                            <h2 className="text-white font-bold text-lg mb-4 flex items-center justify-between border-b border-gray-800 pb-3">
                                Filters
                                    ...
                                    {['Easy', 'Medium', 'Hard'].map(diff => (
                                        <button
                                            ...
                                            className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${selectedDifficulties.includes(diff)
                                                ...
                                                : 'bg-[#0a0f1c] text-gray-400 border border-gray-800 hover:border-gray-600'
                                                }`}
                                        >
                                            {diff}
                                        </button>
                            ...
                            {getUniqueCompanies().length > 0 && (
                                <div>
                                    <h3 className="text-sm font-medium text-gray-400 mb-2 mt-4">Companies</h3>
                            ...
                            {getUniqueTopics().length > 0 && (
                                <div>
                                    <h3 className="text-sm font-medium text-gray-400 mb-2 mt-4">Topics</h3>
                                    <div className="flex flex-wrap gap-2 max-h-48 overflow-y-auto pr-2 custom-scrollbar">
