...
import { Skeleton, SQLChapterSkeleton } from '@/components/Skeleton';
            ...
            {isLoading ? (
              ...
              chapters.map((chapter, index) => (
                <button
                  ...
                  className={`w-full text-left px-4 py-3 rounded-xl transition-all duration-200 flex items-center justify-between group ${currentPage === index + 1
