...
def execute_sql_problem(setup_sql: str, solution_sql: str, user_query: str) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        try:
            ...
            user_columns = [description[0] for description in cursor.description] if cursor.description else []
        ...
        expected_columns = [description[0] for description in cursor_sol.description] if cursor_sol.description else []
