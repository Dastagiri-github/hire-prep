...
Courses of Action: I. Install more traffic signals. II. Impose higher fines for violations.""",
        ...
        },
        {
            ...
            "correct_answer": "0",
            "explanation": "2024 is a leap year, so January 1, 2025 is Monday + 2 days = Wednesday. Wait, 2024 has 366 days, so it's Monday + 2 days = Wednesday. Actually, let me recalculate: 366 days = 52 weeks + 2 days, so Monday + 2 = Wednesday.",
            "time_limit": 60
        },
        {
            "chapter_id": chapters["Logical Reasoning"].id,
